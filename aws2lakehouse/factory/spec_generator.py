...
from aws2lakehouse.factory import (
    PipelineSpec, PipelineFactory, SourceType, TargetMode, 
    SourceConfig, TargetConfig, QualityRule, QualityAction,
    GovernanceConfig, Classification, ComputeConfig, ScheduleConfig,
    AlertConfig
)
...
"""
    ...
    def _build_spec(self, p: Dict) -> PipelineSpec:
        ...
        if schedule in ("continuous", "triggered"):
            cron = None
        else:
            cron = schedule
