...
# MAGIC **Target:** `production.risk_bronze.market_data_feed` | **Mode:** streaming
...
query = (
    ...
    .outputMode("append")
    .option("checkpointLocation", "/Volumes/production/risk_bronze/_checkpoints/market_data_feed")
